...
<div class='t1'>
<form enctype='multipart/form-data' action='/id/{/.node_id}/{if  neq
...
<a href='/id/25'>search</a> ----
<a href='/id/1342/1961033'>setup</a> -----
...
tabindex='23'>
    ...
    {if  eq true}<center><span
class='most_important'></span></center>{/if}
    {if  eq true}
     <center><a href='/id/24/' class='mail'>u have  new
mail,last from </a></center>
    {/if}