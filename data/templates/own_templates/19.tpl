...
<input type='radio' value='0' name='bookstyl'> vsetky bookmarky
<input type='radio' value='1' name='bookstyl'> iba new descendant
<input type='radio' value='2' name='bookstyl'> iba new children
