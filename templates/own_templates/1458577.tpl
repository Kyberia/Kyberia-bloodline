...
-->
    ...
    <div class="top a"></div>
    <div id="cnt">posledny vecer v bruseli rastovi ukradli tasku... bola tam cokolada, komixi bunda nejake veci a fotak z celym prislusenstvom, filmami... cize toto su fotky z mojho a matusovho digitalu ale ja som fotil len obcas a tak vselijak<span style="color:black;">pod niektorymi fotkami su ine obrazky ale pod vecinou nie =]</span></div>
